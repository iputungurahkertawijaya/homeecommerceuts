...
import 'dart:async';
import 'package:homeecommerce/main.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'Product.dart';

void main() => runApp(Mybutik(products: fetchProducts()));
...
Future<List<Product>> fetchProducts() async {
  final response = await http.get('http://192.168.1.19/json/product.json');
...
class Mybutik extends StatelessWidget {
  final Future<List<Product>> products;
  Mybutik({Key key, this.products}) : super(key: key);
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Butix Store")),
        body: Center(
